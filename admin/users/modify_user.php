...
<body>
    ...
    <div class="content">
        ...
        <form name="modificar_usuario" method="POST" action="update_user.php">
            ...
            <table width="50%">
                ...
                <tr>
                    <td>Password</td>
                    <td><input type="password"  class="form-control" name="pass" size="25" value="<?php echo $row['pass']; ?>" /></td>
                </tr>
                <tr>
                    <td>Email</td>
                    <td><input type="text"  class="form-control" name="email" size="25" value="<?php echo $row['email']; ?>" /></td>
                </tr>
                <tr>
                    <td colspan="2">
