...
<body>
    ...
    <div class="content">
        <h1>Usuarios</h1>
        <a class="a_players" href="users/new_user.php">Nuevo usuario</a>
        <p></p>
                ...
                <tbody>
                    ...
                    while ($row = $resultado->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td>
                            <a href="users/modify_user.php?id=<?php echo $row['id']; ?>" title="Modificar"><i class="fa fa-solid fa-pen-to-square"></i></a>
                            <a href="users/delete_user.php?id=<?php echo $row['id']; ?>" title="Elminar"><i class="fa fa-solid fa-trash"></i></i></a>
                            </td>
                            <!--
                            <td>
